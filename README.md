...
*   **[src/](src)**: Source code, utility tools, data producers, and integration flows. Read the [Source README](src/README.md).
    *   **[src/tfds-speedwarning-producer/](src/tfds-speedwarning-producer)**: Google Apps Script checking InfluxDB for real-time and typical speed ratios to publish traffic congestion midpoints as GeoJSON to GCS.
